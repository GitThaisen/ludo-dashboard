![Example](public/img/odashboard-logo-alt-128x92.png?raw=true "Odashboard") Ludo dashboard [![Build Status](https://travis-ci.org/nrkno/odashboard.svg?branch=master)](https://travis-ci.org/nrkno/odashboard)
===
